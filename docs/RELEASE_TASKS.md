...
- `2.21.11` module candidate zip exists and is hash-verified.
...
- The public repo export has been locally advanced to the `2.21.11` candidate.
...
1. Verify the manifest install path using the public repo layout:
   - `module/module.json`
   - `releases/dungeon-masters-forge-v2-2.21.11.zip`
