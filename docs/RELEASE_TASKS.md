...
- A separate `2.22.0-test.5` manifest automatically connects invited testers to Free Forge, removes obsolete project planning gates, and displays structured service failures.
