...
- Added a separate `2.22.0-test.4` tester channel that enables Free Forge automatically while leaving the stable manifest unchanged and removing obsolete user-facing project planning gates.
