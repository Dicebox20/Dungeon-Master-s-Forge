...
## 5. Patreon Quiet Launch

Publish only the launch-day tiers:

- **Apprentice (Free):** module access plus 20 hosted generation requests per calendar month
- **Founding Patron:** **Thank you for your support.** No additional product gate at launch

Link Patreon visitors to the GitHub README, stable manifest, known limitations, and bug-report template. Avoid advertising entitlement checks, image generation, scene transfer, or other roadmap features as available.
