...
- Add early release item-icon image generation as an optional enhancement pass that can create bespoke item icons for generated items without changing the portable mechanical output.
...
- Prepare a project launch packet that states current public access and deferred project access controls.
