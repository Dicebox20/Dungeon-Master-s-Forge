...
Current milestones and deferred automation are tracked in `ROADMAP.md`. Tier planning and early entitlement scaffolding live in `docs/patreon-tiers.md` and `docs/tier-gating-plan.md`, with an offline planning-tier review pass now available in the Forge settings workflow.
